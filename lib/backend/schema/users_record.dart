...
class UsersRecord extends FirestoreRecord {
  ...
  // "chat_disabled" field.
  bool? _chatDisabled;
  bool get chatDisabled => _chatDisabled ?? false;
  bool hasChatDisabled() => _chatDisabled != null;

  // "github_username" field.
  String? _githubUsername;
  String get githubUsername => _githubUsername ?? '';
  bool hasGithubUsername() => _githubUsername != null;
  ...
  void _initializeFields() {
    ...
    _chatDisabled = snapshotData['chat_disabled'] as bool?;
    _githubUsername = snapshotData['github_username'] as String?;
  }
...
class UsersRecordDocumentEquality implements Equality<UsersRecord> {
  ...
  bool equals(UsersRecord? e1, UsersRecord? e2) {
    ...
    return e1?.email == e2?.email &&
        ...
        e1?.chatDisabled == e2?.chatDisabled &&
        e1?.githubUsername == e2?.githubUsername;
  }
