...
Future reorderLessons(
    List<LessonsRecord> lessonsList, int oldIndex, int newIndex) async {
  if (oldIndex < newIndex) {
    newIndex -= 1;
  }

  final LessonsRecord movedLesson = lessonsList.removeAt(oldIndex);
  lessonsList.insert(newIndex, movedLesson);
